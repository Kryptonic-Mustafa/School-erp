...
def main():
    ...
    print(f"[+] Verified Server Backup Directory: {server_bkp_dir}")
    ...
    if not os.path.exists(os.path.join(project_dir, ".git")):
        ...
        with open(os.path.join(project_dir, ".gitignore"), "a") as f:
            f.write("\n/bkp\nnode_modules\n.next\n.env\n")
        print("[+] Created .gitignore to protect /bkp and .env files.")
    ...
    if choice == '1':
        ...
        print("\n[*] Pulling from GitHub...")
        run_cmd("git pull origin main", cwd=project_dir)
